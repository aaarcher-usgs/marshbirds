...
#' 
#' 
save(NWPOINTR2, NWPOINTR2.long, file = "data/processed/NWPOINTR2.Rdata")
...
#' ### Footer
#' 
#' ezspin(file = "althea_programs/01_data_processing.R", out_dir = "output", fig_dir = "figures",keep_md = F)
