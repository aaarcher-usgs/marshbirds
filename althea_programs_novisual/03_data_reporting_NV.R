...
load(file = "data/processed/results_NV.Rdata")
...
#' Figure 3
#' 
#+ NVmodelResults, fig.height = 4, fig.width = 8
...
#' Figure 4
#' 
#+ NVmodelResultsDIFF, fig.height = 4, fig.width = 8
...
#' ### Footer
#' 
#' ezspin(file = "althea_programs_novisual/03_data_reporting_NV.R", out_dir = "output", fig_dir = "figures",keep_md = F)
